...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	clineCatalogService := service.NewClineCatalogService(accountRepository, proxyRepository, httpUpstream, configConfig)
	clineProviderProbeService := service.NewClineProviderProbeService(accountRepository, proxyRepository, httpUpstream, configConfig)
	clineHandler := admin.NewClineHandler(clineCatalogService, clineProviderProbeService)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, gatewayService, pluginManager, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, tlsFingerprintProfileService, identityService, configConfig, coordinator)
