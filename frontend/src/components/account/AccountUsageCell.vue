<template>
  <div ref="rootRef" v-if="showUsageWindows">
    ...
    <!-- CN providers (Kimi / Zhipu / DeepSeek / OpenCode): coding-plan quota or payg balance -->
    <template v-else-if="account.platform === 'kimi' || account.platform === 'zhipu' || account.platform === 'deepseek' || account.platform === 'opencode' || account.platform === 'cline'">
