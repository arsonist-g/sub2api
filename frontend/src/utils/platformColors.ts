...
const BADGE: Record<Platform, string> = {
  ...
  cline: 'bg-rose-500/10 text-rose-600 border-rose-500/30 dark:text-rose-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  cline: 'bg-rose-500/10 text-rose-600 dark:bg-rose-500/10 dark:text-rose-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  cline: 'border-rose-500/20 dark:border-rose-500/20',
}
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  cline: 'border-rose-500/35 dark:border-rose-500/30',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  cline: 'bg-gradient-to-r from-rose-400 to-rose-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  cline: 'text-rose-600 dark:text-rose-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  cline: 'text-rose-500 dark:text-rose-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  cline: 'bg-rose-500 text-white hover:bg-rose-600 active:bg-rose-700 dark:bg-rose-500/80 dark:hover:bg-rose-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  cline: 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  cline: 'from-rose-500 to-rose-600',
}
